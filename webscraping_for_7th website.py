...
# Example usage
url = "https://www.cosmopolitan.com/sex-love/a35450288/valentines-day-pickup-lines/?_x_tr_sl=en&_x_tr_tl=hi&_x_tr_hl=hi&_x_tr_pto=tc"
li_data = scrape_li_data(url)

if li_data:
    print("Data from <li> tags:")
    print(li_data)
    save_to_txt(li_data, 'li_data_cosmopolitan.txt')
else:
